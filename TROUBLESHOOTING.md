...
- **사진 구분 코드(cortAuctnPicDvsCd) 실측**: `000241`=전경도(8장 예) · `000243`=내부구조도 · `000244`=위치도(2장) · `000245`=관련사진(10장) · `000246`=지적도 · `000247`=미확정(신건 2025타경2782 실측, 이름 추측 금지). **전 구분 전부 수집**한다(2026-08-13 상세 패널 도입).
