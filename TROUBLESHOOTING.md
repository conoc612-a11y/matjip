...
- **다른 기타사업 단계명도 같은 이유로 미매칭**(실측, tl 없음 기준 692건): 관리지역고시 75·추진위구성 58·지구지정 26·구역변경 25·지구계획승인(변경) 15·후보지선정 14·사용승인 13·결정고시 8·건축허가 6 등. 사용자가 특정 구역을 문의하면 alias를 추가하는 방식으로 대응(취소·중단·해제·기획완료·사업완료는 의도적으로 미표시).
